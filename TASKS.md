...
- 残る未確認事項：2023-12（41件）、2024-03（51件）、2024-06（1件）、2025-06（1件）は
  次回以降の課題。2026-05-extraordinary（4件）・2026-06（20件）は会議録が公式サイトに
  未公開のため、上記「令和8年度分」BLOCKED（本節冒頭参照）と同じ理由で今回もスコープ外
  （繰り返しアクセスしない）
