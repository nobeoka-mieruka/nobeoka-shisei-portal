...
掲載情報は、延岡市、延岡市議会、選挙管理委員会、国や自治体の公表資料、市長・議員本人が公開している情報などを基に整理しています。

当サイトは延岡市・延岡市議会が運営する公式サイトではなく、非公式の情報整理サイトです。正式な情報は各行政機関の公式資料をご確認ください。

情報の基準日、確認日、出典は各ページまたは各データ項目に記載しています。確認できない情報を推測で掲載しない運用方針としています。顔写真が未登録の議員は、名前の頭文字を使った仮アバターで表示されます。
