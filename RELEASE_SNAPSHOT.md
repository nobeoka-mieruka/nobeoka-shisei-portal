...
このファイルは、Phase197〜200 で固定し、Phase201〜242 の品質改善と、Phase243〜247 の差分更新を反映した安定版の記録です。
...
| 更新履歴エントリ | 137 | 150 | Phase202・208・225・235・236・239・244 の記録 |
| 検索索引エントリ | 2,276 | 2,293 | 上記の追加分が索引化されたもの |
