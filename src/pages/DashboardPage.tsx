  ...
  return (
    <div className="space-y-4 px-4 py-4 sm:px-6">
      ...
      {/* Phase123：市議会の構成に加え、延岡市全体の基礎データ（人口・財政）を1画面で概観できるように
          ...
          データを二重管理しない。
          出生数・死亡数・転入者数・転出者数は、人口の出典としている「現住人口及び世帯数の推移」に
          月ごとの記載があることを2026-09-22に確認済みだが、当サイトへはまだ取り込んでいない。
          高齢化率は、確認できた公式資料に該当する数値が見つかっていない。
          「資料に無い」のか「資料にはあるが当サイトが未収録」なのかを取り違えないよう、
          注記では両者を分けて書く。0や架空値は表示しない。 */}
