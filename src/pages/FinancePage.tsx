    ...
    <div className="mx-auto max-w-3xl space-y-4 px-4 py-4 sm:px-6">
      ...
      <div className="rounded-xl bg-surface-container-low p-4 shadow-e1">
        ...
        <div className="mt-2 flex flex-wrap gap-2 text-xs">
          <Link to="/finance/budget" className={`inline-flex min-h-11 items-center rounded-full bg-surface-container-high px-3 py-1.5 text-primary underline ${linkClass}`}>
            予算・決算規模の推移
          </Link>
          <Link to="/finance/debt" className={`inline-flex min-h-11 items-center rounded-full bg-surface-container-high px-3 py-1.5 text-primary underline ${linkClass}`}>
            市債の推移
          </Link>
      ...
      {/* Phase140項目7：専門用語が並ぶ前に、ページ全体の要点を平易な文章で示す。 */}
