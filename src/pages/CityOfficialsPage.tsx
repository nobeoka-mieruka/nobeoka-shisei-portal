  ...
  return (
    <div className="px-4 py-4 sm:px-6">
      ...
      <div className="mb-5 rounded-xl bg-surface-container-low p-4 text-xs leading-relaxed text-on-surface-variant">
        選挙管理委員会委員については、公式資料で委員全員の氏名・任期を確認できていないため、本ページには未掲載です（委員長のみ報道等で氏名の手がかりがありますが、一次資料での確認が取れ次第、追加します）。監査委員についても、現時点の委員構成（何名で構成され、それぞれ誰が務めているか）を確実に特定できる公式資料を確認できておらず、誤った現職情報を掲載しないため、確認が取れるまで掲載を見送っています。
      </div>
