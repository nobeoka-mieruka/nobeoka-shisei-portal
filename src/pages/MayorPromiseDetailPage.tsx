  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 px-4 py-4 sm:px-6">
                ...
                <li key={m.measureId} className="border-b border-outline-variant pb-4 last:border-0 last:pb-0">
                  ...
                  <p className="mt-1.5 text-xs text-on-surface-variant">
                    ...
                    <a
                      ...
                      className={`ml-1 inline-flex min-h-11 items-center gap-1 text-primary hover:underline ${linkClass}`}
                    >
                      {m.sourceTitle}
      ...
      <SectionCard title="関連する財政データ">
        ...
        <Link
          to="/finance"
          className={`mt-2 inline-flex min-h-11 items-center gap-1.5 text-sm text-primary hover:underline ${linkClass}`}
        >
                ...
                <li key={i} className="relative">
                  ...
                  {entry.kind === "progress_update" && entry.sourceUrl && (
                    <a
                      ...
                      className={`mt-1 inline-flex min-h-11 items-center gap-1 text-xs text-primary hover:underline ${linkClass}`}
                    >
