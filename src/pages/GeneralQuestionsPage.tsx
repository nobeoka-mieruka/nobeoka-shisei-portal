    ...
    <div className="px-4 py-4 sm:px-6">
      ...
      <div className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatCard
          ...
          value={verifiedSpeeches.length}
          unit="件"
          hint="議員1名が1回の登壇で行った質問・答弁のやり取り1回分を1件と数えています。トップページ・データ収録状況ページと同じ集計単位です。"
        />
        <StatCard
          label="質問項目数"
          value={verifiedQuestionItemCount}
          unit="件"
          hint="1回の登壇（上記「一般質問（登壇・確認済み件数）」）で複数のテーマを質問することが多いため、内訳である質問項目数の方が多くなります。"
        />
        <StatCard
          label="収録期間"
