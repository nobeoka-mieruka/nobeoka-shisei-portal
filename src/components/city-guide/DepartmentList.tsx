                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1.5">
                      {telHref ? (
                        <a
                          ...
                          className="inline-flex min-h-11 items-center gap-1.5 rounded text-sm font-medium text-primary underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                        >
                      ...
                      {entry.officialUrl && (
                        <a
                          ...
                          className="inline-flex min-h-11 items-center gap-1.5 rounded text-sm font-medium break-all text-primary underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                        >
