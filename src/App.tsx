...
const PublicCommentsPage = lazy(() =>
  import("./pages/PublicCommentsPage").then((m) => ({ default: m.PublicCommentsPage })),
);
...
const CompareSimilarMunicipalitiesPage = lazy(() =>
  import("./pages/CompareSimilarMunicipalitiesPage").then((m) => ({ default: m.CompareSimilarMunicipalitiesPage })),
);
...
const CouncilActivityHistoryPage = lazy(() =>
  import("./pages/CouncilActivityHistoryPage").then((m) => ({ default: m.CouncilActivityHistoryPage })),
);
        ...
        <div className="flex-1">
          <Suspense fallback={<RouteLoadingFallback />}>
            <Routes>
              ...
              <Route path="/public-comments" element={<PublicCommentsPage />} />
              ...
              <Route path="/compare/similar-municipalities" element={<CompareSimilarMunicipalitiesPage />} />
