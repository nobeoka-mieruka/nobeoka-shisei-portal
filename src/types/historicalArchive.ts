...
/**
 * 出典の信頼レベル（Phase122で新規導入、任意フィールド）。
 * verificationStatusが「この事実がこの資料の記載と一致することを確認したか」を表すのに対し、
 * trustLevelは「この資料自体がどの種類の情報源か」を表す。両者は独立した軸であり、
 * 例えば信頼度の低い資料（NEWS・SOCIAL等）でも記載内容の事実確認自体はverified足りうる。
 *
 ...
 * phase122-sources-findings.md参照）。
 */
