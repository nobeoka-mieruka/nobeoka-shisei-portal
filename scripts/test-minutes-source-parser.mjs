...
const REIWA_BEFORE_SNAPSHOT = {
  ...
  listSessionsForYear: {
    2019: [
      { treedepth: "令和元年 第 1回臨時会 ", label: "令和元年 第 1回臨時会", sessionNumber: "第1回", sessionType: "臨時会" },
      { treedepth: "令和元年 第 2回定例会 ", label: "令和元年 第 2回定例会", sessionNumber: "第2回", sessionType: "定例会" },
      { treedepth: "令和元年 第 3回定例会 ", label: "令和元年 第 3回定例会", sessionNumber: "第3回", sessionType: "定例会" },
      { treedepth: "令和元年 第 4回臨時会 ", label: "令和元年 第 4回臨時会", sessionNumber: "第4回", sessionType: "臨時会" },
      { treedepth: "令和元年 第 5回定例会 ", label: "令和元年 第 5回定例会", sessionNumber: "第5回", sessionType: "定例会" },
    ],
    2020: [
      { treedepth: "令和 2年 第 6回定例会 ", label: "令和 2年 第 6回定例会", sessionNumber: "第6回", sessionType: "定例会" },
      { treedepth: "令和 2年 第 7回臨時会 ", label: "令和 2年 第 7回臨時会", sessionNumber: "第7回", sessionType: "臨時会" },
      { treedepth: "令和 2年 第 8回定例会 ", label: "令和 2年 第 8回定例会", sessionNumber: "第8回", sessionType: "定例会" },
      { treedepth: "令和 2年 第 9回定例会 ", label: "令和 2年 第 9回定例会", sessionNumber: "第9回", sessionType: "定例会" },
      {
    ...
    2023: [
      ...
      { treedepth: "令和 5年 第 1回臨時会 ", label: "令和 5年 第 1回臨時会", sessionNumber: "第1回", sessionType: "臨時会" },
      { treedepth: "令和 5年 第 2回臨時会 ", label: "令和 5年 第 2回臨時会", sessionNumber: "第2回", sessionType: "臨時会" },
      { treedepth: "令和 5年 第 3回定例会 ", label: "令和 5年 第 3回定例会", sessionNumber: "第3回", sessionType: "定例会" },
      { treedepth: "令和 5年 第 4回臨時会 ", label: "令和 5年 第 4回臨時会", sessionNumber: "第4回", sessionType: "臨時会" },
      { treedepth: "令和 5年 第 5回臨時会 ", label: "令和 5年 第 5回臨時会", sessionNumber: "第5回", sessionType: "臨時会" },
      { treedepth: "令和 5年 第 6回臨時会 ", label: "令和 5年 第 6回臨時会", sessionNumber: "第6回", sessionType: "臨時会" },
      { treedepth: "令和 5年 第 7回定例会 ", label: "令和 5年 第 7回定例会", sessionNumber: "第7回", sessionType: "定例会" },
      { treedepth: "令和 5年 第 8回定例会 ", label: "令和 5年 第 8回定例会", sessionNumber: "第8回", sessionType: "定例会" },
    ],
    2024: [
      { treedepth: "令和 6年 第 9回定例会 ", label: "令和 6年 第 9回定例会", sessionNumber: "第9回", sessionType: "定例会" },
